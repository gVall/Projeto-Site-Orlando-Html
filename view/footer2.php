			...
			<div class="row row-cinza-claro">
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-2 col-red d-none d-lg-block">
						...
						<div class="col-md-10 col-red">
							...
							<div class="row row-cols">
								<div class="col-md-4 col-y col-popular-post d-none d-lg-block">
								...
								<div class="col-md-4 col-y col-links d-none d-lg-block">
								...
								<div class="col-md-4 col-y col-get-in-touch">
									
									<h4 class="d-none d-lg-block">GET IN TOUCH</h4>

									<address class="d-none d-lg-block">
										<i class="fa fa-map-marker-alt"></i> <span>618 E. South Street, Suite 510<br/>Orlando, FL 32801</span>
									</address>

									<p class="d-none d-lg-block"><a href="tel:1855ORLCITY"><i class="fa fa-phone"></i>1.855.ORL.CITY</a></p>

									<div class="row d-lg-none aux">

										<div class="col-6">
											<a href="#" class="btn btn-footer"><i class="fa fa-map-marker-alt"></i>Location</a>
										</div>
										<div class="col-6">
		...
		<script src="js/efeitos2.js"></script>
