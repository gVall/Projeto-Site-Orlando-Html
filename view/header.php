...
<html ng-app="shop">
	<head>
		...
		<script src="https://kit.fontawesome.com/3ab8186d7d.js" crossorigin="anonymous"></script>
	...
	<body>
		...
		<header>
				...
				<div id="menu-mobile-mask" class="d-lg-none">
			...
			<div class="header-black">
				...
				<div class="container">
						...
						<input type="search" id="input-search-mobile" class="d-lg-none" placeholder="search...">
						...
						<ul>
							...
							<li class="search">
								<div class="input-group">
									  <input type="search" placeholder="search..." id="busca">
